                ...
                {moviesById && moviesById.data ? (
                   <div className="h-auto">
                       <div className="rounded mb-5">
                            <img className="rounded mb-4 w-full" alt={moviesById.data.Title} src={moviesById.data.Poster} />
                            <h2 className="text-xl font-semibold mb-2">{moviesById.data.Title}</h2>
                       </div>
